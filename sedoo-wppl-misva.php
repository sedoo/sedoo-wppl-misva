...
function sedoo_misva_register() {
	...
	$labels = array(
		...
		'menu_name'             => __( 'Misva Products', 'text_domain' ),
		'name_admin_bar'        => __( 'Misva Products', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Produits de campagnes Misva', 'text_domain' ),
		'labels'                => $labels,
	...
	register_post_type( 'sedoo_misva_products', $args );
